...
const NAMED_SUBSTITUTIONS: Record<string, readonly string[]> = {
  ...
  't-bar row': ['Barbell Row', 'Dumbbell Row', 'Seated Cable Row', 'Band Row'],
  't bar row': ['Barbell Row', 'Dumbbell Row', 'Seated Cable Row', 'Band Row'],
  'landmine press': ['Dumbbell Shoulder Press', 'Seated Dumbbell Shoulder Press', 'Overhead Press'],
  'landmine squat': ['Goblet Squat', 'Front Squat', 'Leg Press'],
  'landmine rdl': ['Romanian Deadlift', 'Dumbbell Romanian Deadlift'],
  'landmine rotation': ['Russian Twist', 'Dead Bug', 'Plank'],

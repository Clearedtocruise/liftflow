...
const leanNativeBuild = stripNative || smokeTest;
...
const config: ExpoConfig = {
  name: smokeTest ? 'LiftFlow Smoke Test' : 'ONE MORE',
  slug: 'liftflow',
  version: '1.0.0',
  runtimeVersion: {
    policy: 'appVersion',
  ...
  ...(disableDeepLinking || smokeTest ? {} : { scheme: 'liftflow' }),

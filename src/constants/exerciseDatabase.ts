...
export const SYSTEM_EXERCISE_CATALOG: CatalogExercise[] = [
  ...
  { slug: 'hanging-leg-raise', name: 'Hanging Leg Raise', movementCategory: 'core', equipment: 'bodyweight', muscleGroups: ['core'], exerciseType: 'strength', loadingMethods: ['bodyweight', 'bodyweight_plus_weight'], metadata: { requires: ['pull_up_bar'], movement_family: 'core_flexion' } },

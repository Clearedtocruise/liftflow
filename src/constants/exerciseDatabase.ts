...
export const SYSTEM_EXERCISE_CATALOG: CatalogExercise[] = [
  ...
  { slug: 'landmine-squat', name: 'Landmine Squat', movementCategory: 'squat', equipment: 'barbell', muscleGroups: ['quads', 'glutes', 'core'], exerciseType: 'strength', metadata: { requires: ['barbell', 'rack'], movement_family: 'squat_pattern' } },
  { slug: 'landmine-rdl', name: 'Landmine RDL', movementCategory: 'hinge', equipment: 'barbell', muscleGroups: ['hamstrings', 'glutes'], exerciseType: 'strength', metadata: { requires: ['barbell', 'rack'], movement_family: 'hinge_pattern' } },
